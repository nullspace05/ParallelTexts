...
- The multilingual embedding model (`distiluse-base-multilingual-cased-v2`) is fetched from Cloudflare R2 on first use.
...
- Model weights are the only thing fetched from a remote server (Cloudflare R2).
